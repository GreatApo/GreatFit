...
public class WeatherWidget extends AbstractWidget {
    ...
    public WeatherData getSlptWeather(Service service) {
        ...
        if (str == null || str.equals( "{\"tempUnit\":\"1\",\"temp\":\"0\\/0\",\"weatherCodeFrom\":0}" )) {
            ...
            //Log.w("com.dinodevs.greatfitwatchface:JSON", str);
        }*/
    ...
    public List<SlptViewComponent> buildSlptViewComponent(Service service) {
        ...
        // Show on log cat
        //Log.w("com.dinodevs.greatfitwatchface", String.format("slpt_weather/clock_skin_weather_%s.png", weatherImageStrList.get(this.weather.weatherType)));
